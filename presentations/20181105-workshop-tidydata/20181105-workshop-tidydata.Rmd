...
You can access all relevant material pertaining to the **2018-11-05 Introduction to Tidy Data w/ R workshop** [here](http://bit.ly/rlel-20181105) on [GitHub](https://bit.ly/rlel-github-meetup) or [Google Drive](https://bit.ly/rlel-gdrive-meetup) >> `presentations` >> `20181105-workshop-tidydata`

## Installation and set-up
### Install RStudio

[**Download RStudio 1.1.463**](http://rstudio.com/download)
...
## Questions? Comments?
Ping us on Slack: <rladies-eastlansing.slack.com> _or_ Email us: eastlansing@rladies.org