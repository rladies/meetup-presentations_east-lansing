...
You can access all relevant material pertaining to the **2018-11-05 Introduction to Tidy Data w/ R workshop** here on [GitHub](https://bit.ly/rlel-github-meetup) or [Google Drive](https://bit.ly/rlel-gdrive-meetup) >> `presentations` >> `20181105-workshop-tidydata`

## Installation and set-up
### Install RStudio

[**RStudio 1.1.463**](http://rstudio.com/download)
...
[**RStudio v1.2.1086**]((https://www.rstudio.com/products/rstudio/download/preview/))
...
**R v3.5.1**
[Download R](https://cran.mtu.edu/)

[*Want to update to the latest version of R?*](https://www.linkedin.com/pulse/3-methods-update-r-rstudio-windows-mac-woratana-ngarmtrakulchol)

[A Windows-specific solution](https://www.r-statistics.com/2015/06/a-step-by-step-screenshots-tutorial-for-upgrading-r-on-windows/)
...
You can also access all relevant R/RStudio/Slack cheatsheets on our [GitHub repo](https://bit.ly/rlel-github-meetup) or [Google Drive folder](https://bit.ly/rlel-gdrive-meetup) >> `cheatsheets`
...
[Their Data](https://www.gapminder.org/data/)

[Tools to generate their trademark bubble charts](https://www.gapminder.org/tools/#$chart-type=bubbles)

Snapshot of their data
![](https://s3-eu-west-1.amazonaws.com/static.gapminder.org/GapminderMedia/wp-uploads/20161007154225/countries_health_wealth_2016_v71.png){width=50%}
...
## Unite
**Collapse cells across several columns into one column**
...
## Separate
**Separate each cell in a column to make multiple columns**
...
## Questions? Comments?
Please ping us on Slack: rladies-eastlansing.slack.com OR Email us: eastlansing@rladies.org