...
```{r GSS-userlevel, out.width = "250px", echo=FALSE}
...
```{r GSS-rusage, out.width = "250px", echo=FALSE}
...
```{r GSS-ruserlevel, out.width = "350px", echo=FALSE}
...
<i class="fa fa-sticky-note fa"></i> Pick your large stickies <br>
...
***
<i class="fa fa-search fa-fw"></i> Find Camille/me <br>
<i class="fa fa-sticky-note fa"></i> Pick your small stickies (Learn/Teach/Help) <br>
<i class="fa fa-pencil fa"></i> Write your names <br>
